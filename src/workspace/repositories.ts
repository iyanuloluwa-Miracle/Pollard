 ...
 *
 * Unreferenced anywhere in src/ as of this restructuring (RepoRegistry does
 * its own discovery above) — kept rather than deleted per the "imports
 * only, no logic changes" constraint on this pass.
 */
